    ...
    <div class="sidebar-menu-inner">
        ...
        <header class="logo-env">
            ...
            <div class="sidebar-collapse">
                <a href="{{ route('dashboard') }}" class="sidebar-collapse-icon"><!-- add class "with-animation" if you want sidebar to have animation during expanding/collapsing transition -->
