            ...
            <div class="w-full mx-auto sm:px-6 lg:px-8">
                <div class="container mx-auto py-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('sadmin_addevaluation') }}" class="rounded bg-green-500 p-1.5 text-white hover:bg-green-700"><i class="ri-add-large-fill"></i> Add Evaluation</a>
                    </div>
                    @if(session('success'))
        ...
        <table class="responsive border-x-2" id="Table">
            ...
            <tbody class="text-gray-600 text-sm font-semibold">
                ...
                <td class="py-3 px-6 whitespace-nowrap flex justify-center gap-2">
                    ...
                    <div>
                        <a class="text-xl text-button hover:text-hover" href="/edit/{{$evaluation->id}}"><i class="ri-edit-fill"></i></a>
                    </div>
...
$(document).ready(function() {
    ...
    function openModal(evaluationId) {
        $.ajax({
            url: '/systemadmin/evaluation/' + evaluationId,
            method: 'GET',
            dataType: 'json',
