            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                <div class="container mx-auto py-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('sadmin_createusers') }}" class="rounded bg-green-500 p-1.5 text-white hover:bg-green-700"><i class="ri-add-large-fill"></i> Add New</a>
                    </div>
                    @if(session('success'))
                                        ...
                                        @foreach ($user as $staffMember)
                                            ...
                                            <tr class="border-b border-gray-200 transition duration-300 ease-in-out text-center hover:bg-gray-100 ">
                                                ...
                                                <td class="py-3 px-6 text-center whitespace-nowrap flex justify-center gap-2">
                                                    <div>
                                                        <a class="text-xl text-button hover:text-hover" href=""><i class="ri-edit-fill"></i></a>
                                                    </div>
