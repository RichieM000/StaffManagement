            ...
            <div class="bg-white shadow-md rounded-lg p-6 mx-auto">
                <form action="/update-users/{{$user->id}}" method="POST" class="grid grid-cols-2 gap-3">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="fname" id="fname" value="{{ $user->fname }}" class="mt-1 p-2 capitalize border border-gray-300 rounded-md w-full" required>
                    </div>
                    <div class="mb-4">
                        <label for="lname" class="block text-sm font-medium text-gray-700">Last Name</label>
                        <input type="text" name="lname" id="lname" value="{{ $user->lname }}" class="mt-1 p-2 border capitalize border-gray-300 rounded-md w-full" required>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4 col-span-2">
                        ...
                        <select name="jobrole" id="jobrole" class="mt-1 p-2 borderoverflow-y-auto border-gray-300 rounded-md w-full" required>
                            ...
                            <option value="SKchairman" {{$user->jobrole == 'SKchairman' ? 'selected' : ''}}>SK Chairman</option>
                        ...
                        <div class="sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="day_of_week" id="day_of_week" class="mt-1 p-2 border overflow-y-auto border-gray-300 rounded-md w-full" required>
                                    <option value="Monday-Friday" {{$user->day_of_week == 'Monday-Friday' ? 'selected' : ''}}>Monday-Friday</option>
                                    <option value="Monday-Saturday" {{$user->day_of_week == 'Monday-Saturday' ? 'selected' : ''}}>Monday-Saturday</option>
                                    <option value="Saturday-Sunday" {{$user->day_of_week == 'Saturday-Sunday' ? 'selected' : ''}}>Saturday-Sunday</option>
