<x-app-layout>
    ...
    <div class="flex">
        ...
        <div class="container mx-auto mt-8">
            <form method="POST" action="/update{{$evaluation->id}}" class="max-w-lg mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                @method('PUT')
                <div class="mb-4">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    const oldTaskId = "{{ old('task_id', $evaluation->task_id ?? '') }}"; // Get the old task ID from the evaluation model
