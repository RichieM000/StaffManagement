<x-app-layout>
    ...
    <div class="flex">
        ...
        <div class="container md:w-3/4 lg:w-9/12 mx-12 py-6">
            ...
            <a href="{{route('admin.task', $task->id)}}" class="bg-button px-6 py-1 text-white rounded-md hover:bg-hover">Back</a>
        </div>
        ...
        <div class="container mx-auto mt-8">
            <form action="{{route('tasks-update', $task->id)}}" method="POST" class="max-w-md mx-auto">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" value="{{ old('title', $task->title) }}" id="title" class="form-input mt-1 block w-full" required>
                </div>
        
                <!-- Task Description -->
                <div class="mb-4">
                    <label for="description" class="block font-medium text-sm text-gray-700">Task Description:</label>
                    <textarea name="description" id="description" rows="3" class="form-textarea mt-1 block w-full" required>{{ old('description', $task->description) }}</textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="date" name="deadline" id="deadline" value="{{ old('deadline', $task->deadline) }}" class="form-input mt-1 block w-full" required>
                </div>
