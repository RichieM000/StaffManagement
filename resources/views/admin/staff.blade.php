            ...
            <div class="w-full mx-auto sm:px-6 lg:px-8">
                <div class="container mx-auto py-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('admin.register') }}" class="rounded bg-green-500 p-1.5 text-white hover:bg-green-700"><i class="ri-add-large-fill"></i> Add New</a>
                    </div>
                    @if(session('success'))
                    ...
                    <form action="{{ route('admin.staff') }}" method="GET" class="flex items-center">
                        ...
                        <script>
                            function exportToExcel() {
                                ...
                                // For simplicity, we'll assume a basic export function here
                                window.location = '/export-excel'; // Example URL for exporting to Excel
                            }
                                    ...
                                    @php $counter = 1 @endphp <!-- Initialize counter -->
                                        @foreach ($user as $staffMember)
                                            ...
                                            <tr class="border-b border-gray-200 transition duration-300 ease-in-out text-center hover:bg-gray-100 ">
                                                ...
                                                <td style="display:flex;align-items: center;border-bottom:0;">
                                                    <div class="pr-3">
